...
public class BedrockRequestBody {
    ...
    public static class BedrockRequestBodyBuilder {
        ...
        public String build() {
            ...
            // Updated switch statement to include newer model IDs and a default case
            switch (modelId) {
                ...
                case "stability.stable-diffusion-xl-v0":
                    ...
                    break;
                default:
                    // Throws an exception for any unsupported model ID, preventing NullPointerException.
...
class AI21LabsCommand extends BedrockBodyCommand {
    ...
    public String execute() {
        ...
        // Note: Map.of is only available from Java 9+, using HashMap for compatibility if needed, 
        // but since this is Bedrock-specific code, assuming modern Java features are fine.
...
class AnthropicCommand extends BedrockBodyCommand {
    ...
    public String execute() {
        ...
        // Cleaned up prompt template to follow standard Human/Assistant formatting
        final String promptTemplate = "Human: ##PROMPT##\n\nAssistant:";
...
class StabilityAICommand extends BedrockBodyCommand {
    ...
    public String execute() {
        ...
        // Note: Map.of is only available from Java 9+, using Map.of is fine for modern codebases.
